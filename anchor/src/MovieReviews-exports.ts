...
import MovieReviewsIDL from '../target/idl/MovieReviews.json'
import type { MovieReviews } from '../target/types/MovieReviews'
...
export function getMovieReviewsProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...MovieReviewsIDL, address: address ? address.toBase58() : MovieReviewsIDL.address } as MovieReviews, provider)
}
